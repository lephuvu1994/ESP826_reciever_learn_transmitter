...
const char *wifi_config_name = "192.168.99.102";
...
//+==============================================================================================================
// Code to string
// Ghi lại max hiển thị ở dạng String lên web
...
//Gửi các mã IR đến các nguồn khác nhau của Type
void irblast(String type, String dataStr, unsigned int len, int rdelay, int pulse, int pdelay, int repeat, long address, IRsend irsend) {   // gui song hong ngoai
  ...
  Serial.println("Transmission complete");                          // in len serial gửi xong
